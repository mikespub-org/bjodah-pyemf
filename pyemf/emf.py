...
class EMF:
    ...
    def ModifyWorldTransform(
        self, mode, m11=1.0, m12=0.0, m21=0.0, m22=1.0, dx=0.0, dy=0.0
    ):
        """
    ...
    def PolyPolyline(self, polylines):
        ...
        """
        return self._appendOptimizePoly16(
            polylines, emr._POLYPOLYLINE16, emr._POLYPOLYLINE
        )
    ...
    def PolyPolygon(self, polygons):
        ...
        """
        return self._appendOptimizePoly16(
            polygons, emr._POLYPOLYGON16, emr._POLYPOLYGON
        )
    ...
    def ArcTo(self, left, top, right, bottom, xstart, ystart, xend, yend):
        ...
        """
        return self._append(
            emr._ARCTO(((left, top), (right, bottom)), xstart, ystart, xend, yend)
        )
    ...
    def CloseFigure(self):
        ...
        """
        return self._append(emr._CLOSEFIGURE())
    ...
    def SelectClipPath(self, mode=RGN_COPY):
        ...
        """
        return self._append(emr._SELECTCLIPPATH(mode))
