...
emf.TextOut(
    100,
    300,
    "This line is drawn while the clipping region is active and should be clipped by the clipping region",
)
...
emf.TextOut(
    0,
    200,
    "This line is drawn after the RestoreDC() and should be bigger and not be clipped by the clipping region",
)
emf.SelectObject(smallfont)
emf.TextOut(
    0,
    400,
    "This line is drawn after the RestoreDC(), should be smaller, and should not be clipped by the clipping region",
)
